const CONFIG = {
  ...
  SITE_CREATE_TIME: '2023-09-22', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://sswblog.netlify.app' },
  ...
  HERO_TITLE_1: '但行好事',
  HERO_TITLE_2: '莫问前程',
  HERO_TITLE_3: 'sswblog.netlify.app',
  HERO_TITLE_4: '早上中午晚上好',
  HERO_TITLE_5: '我的朋友',
  HERO_TITLE_LINK: 'https://sswblog.netlify.app',

  // 英雄区显示三个置顶分类
  HERO_CATEGORY_1: { title: '必看精选', url: '/achieve' },
  HERO_CATEGORY_2: { title: '热门文章', url: '/tag/学习笔记' },
  HERO_CATEGORY_3: { title: '实用教程', url: '/tag/技术分享' },
  ...
  INFO_CARD_URL: 'https://github.com/ssw331/', // 个人资料底部按钮链接
